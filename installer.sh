...
echo "Starting VavooMaker installation..."
...
cleanup() {
    ...
    [ -d "/tmp/VavooMaker-main" ] && rm -rf "/tmp/VavooMaker-main"
}
...
if [ -d "$TMPPATH/VavooMaker-main/usr/lib/enigma2/python/Plugins/Extensions/vavoo-maker" ]; then
    cp -r "$TMPPATH/VavooMaker-main/usr/lib/enigma2/python/Plugins/Extensions/vavoo-maker"/* "$PLUGINPATH/" 2>/dev/null
    echo "✅ Copied from standard plugin directory"
elif [ -d "$TMPPATH/VavooMaker-main/usr/lib64/enigma2/python/Plugins/Extensions/vavoo-maker" ]; then
    cp -r "$TMPPATH/VavooMaker-main/usr/lib64/enigma2/python/Plugins/Extensions/vavoo-maker"/* "$PLUGINPATH/" 2>/dev/null
    echo "✅ Copied from lib64 plugin directory"
elif [ -d "$TMPPATH/VavooMaker-main/usr" ]; then
    # Copy entire usr tree
    cp -r "$TMPPATH/VavooMaker-main/usr"/* /usr/ 2>/dev/null
...
#########################################################
#       VavooMaker $version INSTALLED SUCCESSFULLY      #
